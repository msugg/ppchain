...
BOOST_AUTO_TEST_CASE(suulord_test)
{
    ...
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.4/32");
    suulord = CSubNet("1.2.3.4/255.255.255.254");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.4/31");
    suulord = CSubNet("1.2.3.4/255.255.255.252");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.4/30");
    suulord = CSubNet("1.2.3.4/255.255.255.248");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.0/29");
    suulord = CSubNet("1.2.3.4/255.255.255.240");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.0/28");
    suulord = CSubNet("1.2.3.4/255.255.255.224");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.0/27");
    suulord = CSubNet("1.2.3.4/255.255.255.192");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.0/26");
    suulord = CSubNet("1.2.3.4/255.255.255.128");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.0/25");
    suulord = CSubNet("1.2.3.4/255.255.255.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.3.0/24");
    suulord = CSubNet("1.2.3.4/255.255.254.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.2.0/23");
    suulord = CSubNet("1.2.3.4/255.255.252.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/22");
    suulord = CSubNet("1.2.3.4/255.255.248.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/21");
    suulord = CSubNet("1.2.3.4/255.255.240.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/20");
    suulord = CSubNet("1.2.3.4/255.255.224.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/19");
    suulord = CSubNet("1.2.3.4/255.255.192.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/18");
    suulord = CSubNet("1.2.3.4/255.255.128.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/17");
    suulord = CSubNet("1.2.3.4/255.255.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/16");
    suulord = CSubNet("1.2.3.4/255.254.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/15");
    suulord = CSubNet("1.2.3.4/255.252.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.0.0.0/14");
    suulord = CSubNet("1.2.3.4/255.248.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.0.0.0/13");
    suulord = CSubNet("1.2.3.4/255.240.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.0.0.0/12");
    suulord = CSubNet("1.2.3.4/255.224.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.0.0.0/11");
    suulord = CSubNet("1.2.3.4/255.192.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.0.0.0/10");
    suulord = CSubNet("1.2.3.4/255.128.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.0.0.0/9");
    suulord = CSubNet("1.2.3.4/255.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.0.0.0/8");
    suulord = CSubNet("1.2.3.4/254.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "0.0.0.0/7");
    suulord = CSubNet("1.2.3.4/252.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "0.0.0.0/6");
    suulord = CSubNet("1.2.3.4/248.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "0.0.0.0/5");
    suulord = CSubNet("1.2.3.4/240.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "0.0.0.0/4");
    suulord = CSubNet("1.2.3.4/224.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "0.0.0.0/3");
    suulord = CSubNet("1.2.3.4/192.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "0.0.0.0/2");
    suulord = CSubNet("1.2.3.4/128.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "0.0.0.0/1");
    suulord = CSubNet("1.2.3.4/0.0.0.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "0.0.0.0/0");

    suulord = CSubNet("1:2:3:4:5:6:7:8/ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1:2:3:4:5:6:7:8/128");
    suulord = CSubNet("1:2:3:4:5:6:7:8/ffff:0000:0000:0000:0000:0000:0000:0000");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1::/16");
    suulord = CSubNet("1:2:3:4:5:6:7:8/0000:0000:0000:0000:0000:0000:0000:0000");
    BOOST_CHECK_EQUAL(suulord.ToString(), "::/0");
    suulord = CSubNet("1.2.3.4/255.255.232.0");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1.2.0.0/255.255.232.0");
    suulord = CSubNet("1:2:3:4:5:6:7:8/ffff:ffff:ffff:fffe:ffff:ffff:ffff:ff0f");
    BOOST_CHECK_EQUAL(suulord.ToString(), "1:2:3:4:5:6:7:8/ffff:ffff:ffff:fffe:ffff:ffff:ffff:ff0f");
}
